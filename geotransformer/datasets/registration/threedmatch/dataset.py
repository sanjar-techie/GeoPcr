...
class ThreeDMatchPairDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Initialize estimated_rotation and estimated_translation
        ...
        if self.use_augmentation:
            ...
            # Check if estimated_rotation and estimated_translation are defined
            if estimated_rotation is not None and estimated_translation is not None:
                ...
                # Handle the case where estimated_rotation and estimated_translation are not defined
                # You may want to define a default behavior here
                pass

        # Additional processing if 'rotated' is True
        if self.rotated:
